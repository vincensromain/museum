...
export default function Vestige_6() {
  ...
  const captions = [
    ...
    {
      time: 15.32,
      text: "Certains étaient de la taille d'un moineau, d’autres rivalisaient avec un petit avion. Celui que vous découvrez ici est le Cycnorhamphus suevicus. Il possédait un long bec effilé garni de dents pointues.",
    },
    {
      time: 27.76,
      text: "Son allure évoque un étrange mélange entre un pélican et un dragon miniature. Il planait au-dessus des lagunes et des forêts, à la recherche de poissons ou de petites proies.",
    },
    {
      time: 36.64,
      text: "Inaugurant ainsi la conquête du ciel bien avant l'apparition des oiseaux.",
    },
  ];
